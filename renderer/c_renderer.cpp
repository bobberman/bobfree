...
c_renderer::c_renderer(IDirect3DDevice9* dev)
{
	...
	fonts[fnv1a("pro12")] = c_font("Verdana", 12, FW_REGULAR);
	fonts[fnv1a("pro13")] = c_font("Verdana", 11, FW_NORMAL);
	fonts[fnv1a("indicator_font")] = c_font("Verdana", 20, FW_MEDIUM);
	

	fonts[fnv1a("name_font")] = c_font("Verdana", 11, FW_NORMAL);
	fonts[fnv1a("flag_font")] = c_font("Verdana", 11, FW_NORMAL); 
	fonts[fnv1a("pro17")] = c_font("Verdana", 17, FW_REGULAR);
	fonts[fnv1a("weapons")] = c_font("undefeated", 15, FW_REGULAR);


	fonts[fnv1a("choke_font")] = c_font("Verdana", 14, FW_NORMAL);
	fonts[fnv1a("menu_font")] = c_font("Arial", 16, FW_MEDIUM);
	fonts[fnv1a("menu_controls")] = c_font("Arial", 14, FW_MEDIUM);
...
void c_renderer::loki_gradient(const c_vector2d from, const c_vector2d size, const c_color color1,
	const c_color color2, const c_color color3, const c_color color4 ) const
{
	const auto to = from + size;
	const auto col1 = color1.direct();
	const auto col2 = color2.direct();
