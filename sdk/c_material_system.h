...
class c_material_system : public IAppSystem
{
public:
	...
	virtual bool                            OverrideConfig(const MaterialSystem_Config_t &configs, bool bForceUpdate) = 0;
	...
	virtual bool                            SetMode(void* hwnd, const MaterialSystem_Config_t &configs) = 0;
...
public:
	...
	virtual void                    ColorModulateColor(c_color) = 0;
	...
	virtual void                    GetReflectivity(c_vector3d& reflect) = 0;
