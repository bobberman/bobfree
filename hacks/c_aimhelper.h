...
public:
	...
	static std::optional<std::tuple<c_vector3d, float, c_animation_system::animation*, float>> get_legit_target(float target_fov, float range , std::vector<c_cs_player::hitbox> override_hitbox , bool visible = false);
	static std::optional<std::tuple<c_vector3d, float, c_animation_system::animation*>> get_legit_target(float target_fov, float range = 1.f, std::optional<c_cs_player::hitbox> override_hitbox = std::nullopt, bool visible = false);
	static std::vector<aim_info> select_multipoint(c_animation_system::animation* animation, c_cs_player::hitbox box, int32_t group, float scaled_box);
	...
	static bool is_hitbox_a_body(c_cs_player::hitbox box);
