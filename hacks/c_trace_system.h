...
private:
	static std::optional<wall_pen> fire_bullet(c_base_combat_weapon::weapon_data* data, c_vector3d src, c_vector3d pos, trace_filter* filter, c_cs_player* target = nullptr, bool point = false);

	static bool handle_bullet_penetration(c_base_combat_weapon::weapon_data* weapon_data, game_trace& enter_trace, c_vector3d& eye_position, c_vector3d direction, int& penetrate_count, float& current_damage, float penetration_power);
