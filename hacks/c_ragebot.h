...
public:
	...
	static std::optional<aim_info> scan_record_gun(c_cs_player* local, c_animation_system::animation* animation, std::optional<c_vector3d> pos = std::nullopt);

	static autostop_info& get_autostop_info(c_user_cmd *cmd);
...
private:
	...
	static std::optional<aim_info> scan_record_aimbot(c_cs_player* local, c_animation_system::animation* animation, std::optional<c_vector3d> pos = std::nullopt);
